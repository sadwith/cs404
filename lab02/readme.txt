...
Roll No.: B13210
	...
	The leds were wired to the Beaglebone as given in the figure of the lab.By means of a push button, the led is made to glow by giving appropriate output to the led when input from push button is given to the beaglebone.
